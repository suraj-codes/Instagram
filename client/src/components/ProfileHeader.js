...
const ProfileHeader = ({ profile }) => {
  ...
  const decFollowers = () => {if(followersState>0){setFollowers(followersState - 1);}}
  const handleLogout = () => {
    setUser(null);
      ...
      <Wrapper>
        ...
        <div className="profile-info">
          ...
          <div className="profile-stats">
            <span>{profile?.postCount} <span className="text">posts</span></span>

            <span className="pointer" onClick={() => setFollowersModal(true)}>
              {followersState} <span className="text">followers</span>
            </span>

            <span className="pointer" onClick={() => setFollowingModal(true)}>
              {profile?.followingCount} <span className="text">following</span>
            </span>
          ...
          <div className="bio">
            ...
            <p className="bio__bio">{profile?.bio}</p>
            <a
